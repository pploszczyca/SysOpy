...
int main(int argc, char *argv[]){
    void *lib_handle = dlopen("libblock_library.so", RTLD_LAZY);
    ...
    struct rowMergedFile ** (*makeMainTable)(size_t) = dlsym(lib_handle, "makeMainTable");
    FILE * (*openFileToRead)(char*) = dlsym(lib_handle, "openFileToRead");
    void (*addFilesToArray)(FILE *, FILE *, struct rowMergedFile **, int) = dlsym(lib_handle, "addFilesToArray");
    FILE * (*mergeArrayToTemporaryFile)(struct rowMergedFile **, int) = dlsym(lib_handle, "mergeArrayToTemporaryFile");
    void (*readFromTemporaryFileToArray)(FILE* , struct rowMergedFile **, int) = dlsym(lib_handle, "readFromTemporaryFileToArray");
    void (*removeOneLineFromBlock)(struct rowMergedFile **, int , int ) = dlsym(lib_handle, "removeOneLineFromBlock");
    void (*removeOneBlock)(struct rowMergedFile **, int) = dlsym(lib_handle, "removeOneBlock");
    char ** (*splitTwoFileNames)(char *) = dlsym(lib_handle, "splitTwoFileNames");
